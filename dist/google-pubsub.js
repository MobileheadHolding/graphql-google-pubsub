...
var GooglePubSub = (function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        this.googleSubName2GoogleSubAndClientIds[subName] = __assign(__assign({}, rest), { ids: __spreadArrays(oldIds, [id]) });
                        if (oldIds.length > 0)
                    ...
                    case 1:
                        ...
                        this.googleSubName2GoogleSubAndClientIds[subName] = __assign(__assign({}, googleSubAndClientIds), { messageHandler: messageHandler,
    ...
    GooglePubSub.prototype.unsubscribe = function (subId) {
        ...
        if (ids.length === 1) {
            ...
            this.googleSubName2GoogleSubAndClientIds[subName] = __assign(__assign({}, googleSubAndClientIds), { ids: index === -1 ? ids : __spreadArrays(ids.slice(0, index), ids.slice(index + 1)) });
        }
