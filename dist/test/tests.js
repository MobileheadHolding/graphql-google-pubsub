...
describe('GooglePubSub', function () {
    ...
    it('can subscribe to specific topic and called when a message is published on it', function (done) {
        ...
        pubSub
            ...
            .then(function (subId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it("will not unsubscribe from the topic if there is another subscriber on it's subscriber list", function (done) {
        ...
        Promise.all(subscriptionPromises).then(function (subIds) { return __awaiter(void 0, void 0, void 0, function () {
            var e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    it('subscribe passes through subscription options to google pub sub subscribe', function () { return __awaiter(void 0, void 0, void 0, function () {
...
describe('PubSubAsyncIterator', function () {
    ...
    it('passes through subscription options to google pub sub subscribe', function () { return __awaiter(void 0, void 0, void 0, function () {
